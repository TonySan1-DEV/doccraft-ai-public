...
export default function CharacterDevelopment() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'personality' | 'background' | 'goals' | 'relationships' | 'arc' | 'interaction' | 'enhanced-interaction' | 'advanced-development'>('overview')
  ...
  const createCharacter = () => {
    const newCharacter: Character = {
      ...
      development: {
        currentStage: 0,
        totalStages: 4,
        growthAreas: ['Emotional intelligence', 'Leadership skills', 'Self-confidence'],
  ...
  const generateCharacterSuggestion = () => {
    ...
    toast.success(`Character suggestion: ${randomSuggestion}`)
  }
  ...
  const tabs = [
    ...
    { id: 'advanced-development', label: 'Advanced Development', icon: Activity }
  ]
                ...
                <div className="border-b border-gray-200 dark:border-gray-700 p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        onClick={() => setShowAdvancedDevelopment(!showAdvancedDevelopment)}
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            <div>
                              ...
                              <p className="text-gray-900 dark:text-white">{selectedCharacter.role}</p>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Archetype:</span>
                              <p className="text-gray-900 dark:text-white">{selectedCharacter.archetype}</p>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Primary Goal:</span>
                              <p className="text-gray-900 dark:text-white">{selectedCharacter.goals.primary}</p>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Character Arc:</span>
                              <p className="text-gray-900 dark:text-white">{selectedCharacter.arc.type}</p>
                            </div>
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="space-y-3">
                            <div>
                              ...
                              <p className="text-gray-900 dark:text-white">
                                {selectedCharacter.development.currentStage + 1} of {selectedCharacter.development.totalStages}
                              </p>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Growth Areas:</span>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Strengths:</span>
                              <div className="flex flex-wrap gap-1 mt-1">
                            ...
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Weaknesses:</span>
                              <div className="flex flex-wrap gap-1 mt-1">
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Fears:</span>
                              <div className="flex flex-wrap gap-1 mt-1">
                            ...
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Desires:</span>
                              <div className="flex flex-wrap gap-1 mt-1">
                            ...
                            {selectedCharacter.personality.mbti && (
                              <div>
                                <span className="text-sm font-medium text-gray-500 dark:text-gray-400">MBTI:</span>
                                <p className="text-gray-900 dark:text-white">{selectedCharacter.personality.mbti}</p>
                              </div>
                            )}
                            {selectedCharacter.personality.enneagram && (
                              <div>
                                <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Enneagram:</span>
                                <p className="text-gray-900 dark:text-white">{selectedCharacter.personality.enneagram}</p>
                              </div>
                            )}
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            <div>
                              ...
                              <p className="text-gray-900 dark:text-white">{selectedCharacter.background.origin}</p>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Family:</span>
                              <p className="text-gray-900 dark:text-white">{selectedCharacter.background.family}</p>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Education:</span>
                              <p className="text-gray-900 dark:text-white">{selectedCharacter.background.education}</p>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Occupation:</span>
                              <p className="text-gray-900 dark:text-white">{selectedCharacter.background.occupation}</p>
                            </div>
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="space-y-2">
                            {selectedCharacter.background.significantEvents.map((event, index) => (
                              <div key={index} className="p-3 bg-gray-50 dark:bg-gray-700 rounded">
                                <p className="text-gray-900 dark:text-white text-sm">{event}</p>
                              </div>
                            ))}
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Internal Goal:</span>
                              <p className="text-gray-900 dark:text-white">{selectedCharacter.goals.internal}</p>
                            </div>
                            <div>
                              <span className="text-sm font-medium text-gray-500 dark:text-gray-400">External Goal:</span>
                              <p className="text-gray-900 dark:text-white">{selectedCharacter.goals.external}</p>
                            </div>
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="space-y-2">
                            {selectedCharacter.goals.secondary.map((goal, index) => (
                              <div key={index} className="p-3 bg-gray-50 dark:bg-gray-700 rounded">
                                <p className="text-gray-900 dark:text-white text-sm">{goal}</p>
                              </div>
                            ))}
                          </div>
                        </div>
                          ...
                          <div className="space-y-2">
                            {selectedCharacter.relationships.allies.map((ally, index) => (
                              <div key={index} className="p-3 bg-green-50 dark:bg-green-900/20 rounded">
                                <p className="text-gray-900 dark:text-white text-sm">{ally}</p>
                              </div>
                            ))}
                          </div>
                        </div>
                          ...
                          <div className="space-y-2">
                            {selectedCharacter.relationships.enemies.map((enemy, index) => (
                              <div key={index} className="p-3 bg-red-50 dark:bg-red-900/20 rounded">
                                <p className="text-gray-900 dark:text-white text-sm">{enemy}</p>
                              </div>
                            ))}
                          </div>
                        </div>
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="space-y-4">
                          <div>
                            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Arc Type:</span>
                            <p className="text-gray-900 dark:text-white">{selectedCharacter.arc.type}</p>
                          </div>
                          <div>
                            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Description:</span>
                            <p className="text-gray-900 dark:text-white">{selectedCharacter.arc.description}</p>
                          </div>
                          <div>
                            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Stages:</span>
                    ...
                    <div>
                      <EnhancedCharacterChat
                        ...
                        onCharacterUpdate={(updatedCharacter) => {
                          // Convert back to Character interface and update
                          const updatedChar: Character = {
                            ...selectedCharacter,
                            name: updatedCharacter.name,
                            personality: {
                              ...selectedCharacter.personality,
                              traits: updatedCharacter.personality.traits,
                              strengths: updatedCharacter.personality.strengths,
                              weaknesses: updatedCharacter.personality.weaknesses,
                              fears: updatedCharacter.personality.fears,
                              desires: updatedCharacter.personality.desires
                            },
                            goals: {
                              ...selectedCharacter.goals,
                              primary: updatedCharacter.goals.primary,
                              secondary: updatedCharacter.goals.secondary,
                              internal: updatedCharacter.goals.internal,
                              external: updatedCharacter.goals.external
                            },
                            voiceStyle: updatedCharacter.voiceStyle,
                            worldview: updatedCharacter.worldview,
                            backstory: updatedCharacter.backstory,
                            development: {
                              ...selectedCharacter.development,
                              developmentNotes: updatedCharacter.developmentNotes
                            }
                          }
