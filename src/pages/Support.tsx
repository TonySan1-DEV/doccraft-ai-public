...
export const Support: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "tickets" | "chat" | "faq" | "create"
  >("overview");
        ...
        const mockTickets: SupportTicket[] = [
          {
            ...
            description:
              "Would like to see a dark mode option for better visibility.",
            status: "open",
            priority: "medium",
          ...
          },
          {
            ...
            description:
              "Export function is not working properly in Chrome browser.",
            status: "in_progress",
            priority: "high",
            category: "bug_report",
            userId: mockUser.id,
          ...
          },
          {
            ...
            description:
              "What are the current API rate limits for the Pro plan?",
            status: "resolved",
            priority: "low",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 flex flex-col">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        {/* Live Chat Widget */}
        {showChat && (
          <SupportChat onClose={() => setShowChat(false)} userId={user?.id} />
        )}
      </div>
