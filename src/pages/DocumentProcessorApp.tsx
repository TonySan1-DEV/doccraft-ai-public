...
const LayoutWrapper: React.FC<{ children: React.ReactNode }> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <Sidebar />
      <div
        className={`lg:ml-16 pt-16 transition-all duration-300 ${!isSidebarCollapsed ? 'lg:ml-64' : ''}`}
      >
        {children}
      </div>
    </div>
  ...
  const tabs = [
    {
      ...
      label: 'Upload',
      icon: Upload,
      description: 'Import your document',
    },
    {
      id: 'editor' as Tab,
      label: 'Editor',
    ...
    },
    {
      ...
      label: 'Images',
      icon: Image,
      description: 'AI visual suggestions',
    },
    {
      id: 'settings' as Tab,
      label: 'Settings',
      icon: Settings,
      description: 'Configure enhancement',
    },
  ];
              ...
              {tabs.map(tab => {
                ...
                return (
                  <button
                    ...
                    disabled={
                      isViewer && (tab.id === 'upload' || tab.id === 'settings')
                    }
                    className={`
                ...
                <div className="p-8">
                  {document ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 mb-6">
                        Upload a document first to start editing
                      </p>
                      <button
                ...
                <div className="p-8">
                  {document ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 mb-6">
                        Upload a document first to get AI image suggestions
                      </p>
                      <button
                        onClick={() => setActiveTab('upload')}
                        disabled={isViewer}
                ...
                <div className="p-8">
                  {isViewer ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 mb-6">
                        Viewer role cannot access settings
                      </p>
                    </div>
                  ) : (
                    <EnhancementSettings
